...
const Projectcard = (props) => {
    ...
    const yes = `${strb} bg-cover inline-block col-span-2 inline-block w-full h-full md:w-full md:h-full bg-lime-400 dark:bg-lime-400 top-0 right-0`


    
    return (
        <div className="mx-auto w-full text-sm font-medium text-gray-900 bg-white border-b border-gray-200 dark:bg-white dark:border-gray-600 dark:text-black">
