const Courseskills = () => {
  ...
  const ucourses = [
    ...
    {
      ser: "ECE 17: ",
      title: "Object-Oriented Programming: Design and Development with C++",
    },
  ...
  const pskills1 = ["Python • Golang • C/C++ • JavaScript/TypeScript • MATLAB"];
  const pskills2 = [
    "Java • C# • MySQL • Haskell • LabVIEW • CUDA • Verilog • ARM Assembly",
  ];
  const webdev = [
            ...
            <div className="md:hidden flex flex-row justify-center p-3 h-fit">
              <div class="flex justify-center">
                <ul class="h-96 overflow-y-auto bg-white rounded-lg border border-gray-400 w-full text-gray-900">
                  <li class="bg-gray-200 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-0 focus:bg-gray-200 focus:text-gray-600 transition duration-500 cursor-pointer px-6 py-2 border-b border-gray-400 w-full ">
                    Graduate Courses
                  </li>
                  {gcourses.map((dat) => (
                    <li
                      key={dat.title}
                      class="hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-0 focus:bg-gray-200 focus:text-gray-600 transition duration-500 cursor-pointer px-6 py-2 border-b border-gray-200 w-full rounded-t-lg"
                    >
                      <span className="font-bold">{dat.ser}</span>
                      {dat.title}
                    </li>
                  ))}
