const Card = (props) => {
    ...
    return (
        ...
        <div className=" ">
            ...
            <div className="p-5 bg-slate-100 inline-block rounded-lg">
                <a href="#">
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-rose-500 ">{props.dat.title}</h5>
                </a>

                <div className="flex pb-3">
                    <ul className="w-full text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 dark:bg-white dark:border-gray-600 dark:text-black">
                    {
                        work.map(bullet => 
