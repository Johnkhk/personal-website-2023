...
const Projects = () => {
  const project_data = [
    {
      title: "CLI Chat App",
      pic: "bg-[url('/imgs/thumbnails/cli_chat.png')]",
      desc: [
        "CLI Chat App is an open-source end-to-end encrypted terminal-based chat application that allows users to manage their friends list and chat with each other in real-time.",
        "The application is built using Golang, gRPC, BubbleTea TUI, and the Signal Protocol for secure and encrypted communication.",
      ],
      code: "https://github.com/Johnkhk/cli_chat_app",
    },
    {
      title: "ProApplyAI",
    ...
    {
      title: "Fault Tolerant & Scalable SurfStore (Raft)",
    ...
    },
    {
      ...
      link2:
        "https://www.youtube.com/watch?v=fviCBW3Zr4U&t=15s&ab_channel=JawnHo",
      code: "",
    },
    {
      ...
      paper:
        "https://github.com/Johnkhk/Particle-Filter-Slam-and-Texture-Mapping/blob/main/particle_filter_slam.pdf",
    },
    {
      ...
      paper:
        "https://github.com/Johnkhk/Extended-Kalman-Filter-SLAM/blob/main/ece276a_pr3_EKF%20(3).pdf",
    },
    {
    ...
    },
    {
      ...
      link2:
        "https://www.youtube.com/watch?v=HJUQz3LXsNM&t=35s&ab_channel=JawnHo",
      code: "",
      paper: "",
    },
    {
      ...
      demolink: "",
      link2:
        "https://www.youtube.com/watch?v=gsOpZBwbeM0&t=26s&ab_channel=JawnHo",
      code: "",
      paper:
        "https://github.com/Johnkhk/personal-website-2023/blob/main/public/pdfs/ECE268_WI22_P7_KwokHungHo_JesusVillavazoFausto.pdf",
    },
  ];
  return (
    <>
